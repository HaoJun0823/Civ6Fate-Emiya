...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="F:\Mods\CIV\2019\RESOURCE\FATE_EMIYA\LEADER_FSN_ARCHER_EMIYA_NEUTRAL.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>3450644178</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="LEADER_FSN_ARCHER_EMIYA_NEUTRAL.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="LEADER_FSN_ARCHER_EMIYA_NEUTRAL"/>
	<m_Description text=""/>
	<m_Tags>
